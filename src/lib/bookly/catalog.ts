      ...
      { name: "metadata", type: "object", description: "Any extra structured context for staff." },
      {
        ...
        items: {
          ...
          fields: [
            ...
            { name: "intent_confidence", type: "number", required: true, description: "0-1 confidence in the understood intent AT THIS TURN. Required on every agent/tool turn; rendered as a pie chart." },
            { name: "resolution_confidence", type: "number", required: true, description: "0-1 confidence that this turn moves toward/achieves resolution. Required on every agent/tool turn; rendered as a pie chart." },
            { name: "metadata", type: "object", description: "Structured extras shown next to the turn (policy id, rule that fired…)." },
          ],
        },
      },
    ],
