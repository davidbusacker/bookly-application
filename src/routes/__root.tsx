...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bookly — AI Customer Support Console" },
      { name: "description", content: "Bookly's support operations console and Decagon AI agent insights." },
      { property: "og:title", content: "Bookly — AI Customer Support Console" },
      { property: "og:description", content: "Bookly's support operations console and Decagon AI agent insights." },
